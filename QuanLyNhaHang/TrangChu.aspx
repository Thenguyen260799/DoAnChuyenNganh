...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>PHỤC VỤ TIỆC NHÀ HÀNG</h2>
            ...
            <div class="hero-image">
                <div class="hero-text">
                    <h1 style="font-size: 50px">THỰC ĐƠN HOT</h1>
                    <h4>0944889999</h4>
    ...
    <h2>KHÔNG GIAN NHÀ HÀNG</h2>
            ...
            <div id="trai">
                <img class="mySlides " src="Images/KGNH/tiectrongnha.jpg" style="width: 1900px; height: 600px;">
                <img class="mySlides " src="Images/KGNH/ngoaitroi.jpg" style="width: 1900px; height: 600px;">
                <img class="mySlides " src="Images/KGNH/vip2.jpg" style="width: 1900px; height: 600px;">
                <img class="mySlides " src="Images/KGNH/noi-to-chuc-tiec-tat-nien-tot-nhat-sai-gon-tn.jpg" style="width: 1900px; height: 600px;">
                <img class="mySlides " src="Images/KGNH/sinhnhat.jpg" style="width: 1900px; height: 600px;">
                <img class="mySlides " src="Images/KGNH/bep.jpg" style="width: 1900px; height: 600px;">
            </div>
        </div>
    <script>
        var myIndex = 0;
